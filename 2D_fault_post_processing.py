...
def save_clusters_npz(
    ...
    """Save final clusters without object arrays or pickle."""
...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("input_segy", type=Path, help="Input regular-grid SEG-Y file.")
    parser.add_argument("model_weights", type=Path, help="UASS-Net model state dictionary.")
    ...
    parser.add_argument("--output-pickle", type=Path, default=None)
